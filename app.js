...
{id:"A02",type:"single",axis:"action",text:"암장 최대 체류시간",options:[{text:"~2시간",value:0},{text:"2시간~5시간",value:1},{text:"5시간~8시간",value:2},{text:"7시간 이상",value:3}]},
...
{id:"G03",type:"single",axis:"growth",text:"클라이밍 때문에 감정적으로 흔들린 적",options:[{text:"없다",value:0},{text:"아쉬워서 짜증 난 정도",value:1},{text:"다시 한다",value:2},{text:"진짜로 울거나 멘탈 터진 적 있음",value:3}]},
...
function renderRadar(data){
  ...
  radarChartInstance=new Chart(canvas,{type:"radar",data:{labels,datasets:[{data,borderWidth:2,pointRadius:2}]},options:{responsive:false,plugins:{legend:{display:false}},scales:{r:{min:1,max:4,ticks:{display:false,stepSize:1},grid:{circular:false}}}}});
}
...
async function saveCard(){
  ...
  if(!card||typeof html2canvas==="undefined"){alert("저장 기능 준비가 안 됨!");return}
  const canvas=await html2canvas(card,{scale:2,useCORS:true,backgroundColor:"#ffffff"});
  const a=document.createElement("a");a.href=canvas.toDataURL("image/png");a.download="climbing_addict_result.png";a.click();
}
